  ...
  let type // Class/Interface? Have this one file, or two separate?
    return{
        ...
        draw: ()=>{
            ...
            rect.setAttribute('stroke-dashoffset', 20)
            ...
            if (text !== undefined){
                ...
                textBox.setAttributeNS("x",x)      
                textBox.setAttributeNS("y",y)  
                newTtextBoxext.setAttributeNS(null,"font-size","20") 
        
                let textNode = document.createTextNode('rect') 
